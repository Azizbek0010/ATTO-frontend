...
function PinPage() {
    ...
    const handleVerifyPin = useCallback(async () => {
        ...
        try {
            ...
            const res = await fetch(import.meta.env.VITE_BACKEND + "/api/auth/verify-pin", {
                method: "POST",
    ...
    return (
        <div className="min-h-screen flex flex-col justify-between items-center bg-gradient-to-b from-black via-gray-900 to-black py-12 select-none">

            <div className="w-full flex justify-end px-6">
                <button
                    onClick={handleLogout}
                    disabled
                    className="text-purple-400 text-sm font-medium cursor-no-drop"
                >
                    Kira olmayapsizmi?
                </button>
            </div>
            ...
            <div className="flex flex-col items-center gap-10">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-white text-4xl font-extrabold tracking-widest uppercase drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
                        {userName.split(" ")[1] || "..."}
                    </p>
                </div>
            ...
            <div className="grid grid-cols-3 gap-4 px-8 w-full max-w-[340px]">
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(num => (
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center justify-center h-20 rounded-full 
            ...
            transition-all duration-200 shadow-lg"
                ...
                <button
                    ...
                    className="flex items-center justify-center h-20 rounded-full "
                >
                    <svg fill="#bdbdbd" width="40px" height="40px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
