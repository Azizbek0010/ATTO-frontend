...
const DashboardLayout = () => {
    ...
    const hideDockPages = ["/profile", "/transfer", "/card-details"]
    const showDock = !hideDockPages.includes(location.pathname)

    return (
        <div className={`min-h-screen bg-base-200 ${showDock ? "pb-16" : ""}`}>
            ...
            {showDock && (
                <div className="dock dock-sm max-w-[500px] mx-auto  fixed rounded-t-2xl bottom-0 left-0 right-0 bg-base-100 border-t border-base-content/10 z-50">

                    <button onClick={() => navigate("/dashboard")} className={isActive("/dashboard") ? "dock-active" : ""}>
                        ...
                        <span className="dock-label">Bosh</span>
                    </button>

                    <button onClick={() => navigate("/payments")} className={isActive("/payments") ? "dock-active" : ""}>
                        <svg className="size-[1.2em]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <g fill="currentColor" strokeLinejoin="miter" strokeLinecap="butt">
                        ...
                        <span className="dock-label">To'lovlar</span>
                    </button>



                    <button onClick={() => navigate("/settings")} className={isActive("/settings") ? "dock-active" : ""}>
                        <svg className="size-[1.2em]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <g fill="currentColor" strokeLinejoin="miter" strokeLinecap="butt">
                        ...
                        <span className="dock-label">Sozlamalar</span>
                    </button>
